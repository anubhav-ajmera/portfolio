...
export const InstagramIcon = ({ width = 24, height = 24, color = 'currentColor', className = '' }: IconProps) => (
	<svg viewBox='0 0 24 24' width={width} height={height} role='presentation'>
		<path
...
export const LocationIcon = ({ width = 24, height = 24, color = 'currentColor', className = '' }: IconProps) => (
	<svg viewBox='0 0 297 297' width={width} height={height} role='presentation' fill={color} className={className}>
		<path
